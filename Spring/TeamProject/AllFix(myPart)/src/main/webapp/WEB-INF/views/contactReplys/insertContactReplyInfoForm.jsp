  ...
  <head>
	...
	$(document).ready(function() {
		...
		$(".action-insert").on("submit", function(e){ 
			...
			$(this).ajaxSubmit({
				type:"post",
				url:"/contactReplys/insertContactReplyInfoProc.json",
		...
		<div class="row clearfix">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="card">
					...
					<div class="body">
						<input id="conSeqNo" type="hidden" name="seqNo" value="${param.seqNo}">
						<input type="hidden" name="replySeqNo" value="${param.replySeqNo}">
						<table class="table">
							<tr>
								<th>댓글 입력</th>
								<td>
